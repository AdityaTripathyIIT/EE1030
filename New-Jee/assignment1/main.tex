...
\item[18.] Let the line $y = mx$ and the ellipse $2x^2 + y^2 = 1$ intersect a point P in the first quadrant. If the 
	...
	\begin{figure}[h!]
   		\centering
   		\includegraphics[width=0.7\linewidth]{figs/q18.png}
   		\caption{Figure for q18}
	\end{figure}
...
\\
	\item[22.] Let the normal at a point $P$ on the curve $y^2 - 3x^2 + y + 10 = 0$ intersect the y-axis at 
		...
		\begin{figure}[h!]
  			\centering
			\includegraphics[width=0.7\linewidth]{figs/q22.png}
...
\\
	...
	\end{align} is
\\
	\item[25.] The number of all 3x3 matrices $A$, with entries from the set $\{-1, 0 , 1\}$, such that the sum
