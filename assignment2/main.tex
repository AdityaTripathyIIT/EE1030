...
\begin{enumerate}
	...
	\item[7.] If the system of equations
		\begin{align*}
...
\item[8.] Let $\omega = -\frac{1}{2} +i\frac{\sqrt{3}}{2}$. Then the value of the determinant \hfill{\brak{2002S}}
	...
	\item[9.] The number of values of $k$ for which the system of equations 
		\begin{align*}
	...
	\item[12.]  Given \begin{align*} 2x-y+2z=2,\\x-2y+z=-4,\\x+y+\lambda z=4 \end{align*} then the value of $\lambda$ such that the given system of equation has NO solution, is
