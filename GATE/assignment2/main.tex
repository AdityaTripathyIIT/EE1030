...
\item 
        ...
        \resizebox{0.5\textwidth}{!}{%
            \begin{circuitikz}
                ...
                \node [font=\LARGE] at (8.25,18.75) {A};
                \node [font=\LARGE] at (8.25,17.75) {B};
                \node [font=\LARGE] at (19.75,17.75) {Q};
            \end{circuitikz}
            }
        \end{center}
                ...
                \item 
                    \begin{center}
                        \begin{tikzpicture}[scale = 0.5]
                            % Draw axes
                            \draw[->] (-1,0) -- (3,0) node[right] {$T$}; % x-axis
                            \draw[->] (0,-0.1) -- (0,1.1) node[above] {$C_v$}; % y-axis
                ...
                \item 
                    \begin{center}
                        \begin{tikzpicture}[scale = 0.5]
                            ...
                            \draw[->] (0,-3) -- (0,3) node[above] {$C_v$};

                            % Draw the function y = 1/x
                            \draw[domain=0.3:3.5,smooth,variable=\x,black] plot ({\x},{1/\x});
                        \end{tikzpicture}
                    \end{center}
                \item 
                    \begin{center}
