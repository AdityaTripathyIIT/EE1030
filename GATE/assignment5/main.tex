...
\\
    ...
    \item[13.] Match the reaction in $\textbf{Column I}$ with its name in $\textbf{Column II}$.\\
        ...
        \begin{enumerate}
                ...
                \end{multicols}
        \end{enumerate}
    \item[14.] The Young's modulus of a unidirectional $SiC$ fiber reinforced $Ti$ matrix is 185 $GPa$.
...
\begin{multicols}{2}
    ...
    \item[20.] Relevant portion of a binary phase diagram of elements A and B is shown below. The mass fraction
        ...
        \begin{center}
            \resizebox{0.5\textwidth}{!}{%
                \begin{circuitikz}
                    ...
                    \node [font=\LARGE] at (3.5,18.5) {$L + \alpha$};
                    ...
                    \node [font=\LARGE, rotate around={90:(0,0)}] at (0.5,15) {Temperature in$^{\degree}C$              };
                \end{circuitikz}
                }%
        \end{center}
    \item[21.] The expected diffraction angle $\brak{\textnormal{in degrees}}$for the first order reflection from the $\brak{113}$ set of planes
        ...
        wavelength 0.1542 nm is
            \hfill{\brak{2014-XE}}
        \item[22.] The diffusion coefficients of i$Mg$ in $Al$ at 500 and $550^{\degree}C$ are $1.9\times 10^{-13}$
